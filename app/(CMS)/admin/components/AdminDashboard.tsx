              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-sage-200 dark:bg-sage-700 flex items-center justify-center flex-shrink-0">
                    <span className="text-sm font-bold text-sage-700 dark:text-sage-200">1</span>
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-sage-200 dark:bg-sage-700 flex items-center justify-center flex-shrink-0">
                    <span className="text-sm font-bold text-sage-700 dark:text-sage-200">2</span>
                  </div>
                  <div>
                    <h4 className="font-medium text-sage-900 dark:text-sage-100">
                ...
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-sage-200 dark:bg-sage-700 flex items-center justify-center flex-shrink-0">
                    <span className="text-sm font-bold text-sage-700 dark:text-sage-200">3</span>
                  </div>
                  <div>
                    <h4 className="font-medium text-sage-900 dark:text-sage-100">
                ...
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-sage-200 dark:bg-sage-700 flex items-center justify-center flex-shrink-0">
                    <span className="text-sm font-bold text-sage-700 dark:text-sage-200">4</span>
                  </div>
                  <div>
                    <h4 className="font-medium text-sage-900 dark:text-sage-100">
                      Publish Changes
            ...
            <CardContent className={posts.length === 0 ? "py-12" : "p-6"}>
              {isLoading ? (
                ...
                <div className="text-center">
                  ...
                  <h3 className="font-medium text-slate-900 dark:text-white mb-1">No posts yet</h3>
