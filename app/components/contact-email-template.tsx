      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ color: "#4a5568", lineHeight: "1.8" }}>
              ...
              <p style={{ margin: "5px 0" }}>
                <strong>Service Required:</strong> {service}
              </p>
              <p style={{ margin: "5px 0" }}>
        ...
        >
          <p style={{ margin: "0 0 10px 0" }}>
            <strong>Adwait Artha LLP</strong>
          </p>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ color: "#4a5568", lineHeight: "1.6" }}>
          Please review this inquiry and respond to the client within 24 hours. You can contact them
          at {email} or {phone ? phone : "the provided email"}.
        </p>
        <div
          style={{
            background: "#e6fffa",
