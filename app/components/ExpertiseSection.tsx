...
export function ExpertiseSection() {
  ...
  const processSteps = [
    ...
    },
    {
      ...
      description: 'Execution of financial strategies with meticulous attention to regulatory compliance.',
      details: ['Documentation', 'Compliance Check', 'Stakeholder Coordination', 'Process Monitoring'],
  ...
  const expertiseAreas = [
    ...
    },
    {
      ...
      skills: ['Strategic Planning', 'Financial Restructuring', 'Valuation Services', 'Risk Management'],
      percentage: 98,
      color: 'from-sage-400 to-sage-500'
    },
    {
