...
export function AboutSection() {
  ...
  return (
    <section
      id="about"
      className="relative py-24 bg-gradient-to-br from-sage-800 via-sage-900 to-black overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-sage-300 max-w-3xl mx-auto">
            Adwait Artha LLP is a prestigious financial advisory firm headquartered in Ahmedabad,
            Gujarat, delivering exceptional financial and legal services for over two decades. Our
            clientele spans across Gujarat, Maharashtra, and various regions throughout India, as
            well as international markets including the USA, Netherlands, and Singapore.
          </p>
        </motion.div>
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sage-300 leading-relaxed">
                To provide comprehensive financial advisory services that empower businesses to
                achieve their growth objectives through strategic planning, regulatory compliance,
                and innovative solutions. We strive to be the trusted partner for all financial and
                legal needs.
              </p>
            </div>
            <div>
              ...
              <p className="text-sage-300 leading-relaxed">
                To be the leading financial advisory firm in India, recognized for our expertise,
                integrity, and commitment to client success. We aim to create lasting value for our
                clients through innovative solutions and exceptional service delivery.
              </p>
            </div>
          </motion.div>
          <motion.div
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {achievements.map((achievement, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-16 h-16 bg-gradient-to-br ${achievement.color} rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg`}
                  >
                    <IconComponent className="w-8 h-8 text-sage-900" />
                  </div>
