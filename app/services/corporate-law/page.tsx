...
import { Building, CheckCircle, ArrowLeft, Phone, Mail, Users, FileText, Calendar, Shield } from 'lucide-react';
  ...
  const meetingServices = [
    {
      ...
      description: 'Comprehensive support for board meetings including agenda preparation, documentation, and compliance.',
      features: ['Agenda Preparation', 'Notice Circulation', 'Minutes Drafting', 'Compliance Reporting']
    },
    {
      title: 'Annual General Meetings',
      description: 'End-to-end AGM management including physical and virtual meeting arrangements.',
      features: ['Meeting Arrangements', 'Proxy Management', 'Voting Systems', 'Regulatory Compliance']
    },
    {
      title: 'E-Voting Services',
      description: 'Modern electronic voting solutions for shareholder meetings and corporate decisions.',
      features: ['Online Voting Platform', 'Secure Authentication', 'Real-time Results', 'Audit Trail']
    }
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-20">
        ...
        >
          ...
          <p className="text-xl text-sage-300 max-w-4xl mx-auto">
            ...
            From board meetings to AGMs, we ensure your business operates in full compliance with regulatory requirements.
          </p>
        </motion.div>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            >
              ...
              <p className="text-sage-300 leading-relaxed mb-6">
                In the field of Corporate Law, the scope of work would be to assist the companies (Pvt. Ltd./ Public Limited/Section 8 Companies 
                and Listed Companies) in compliance with all provisions of the corporate law and related laws on a best effort basis. 
                The firm provides advisory services in handling Board Meeting, Annual General Meeting whether physically or through e-means live video conference.
              </p>
              <p className="text-sage-300 leading-relaxed">
                Our comprehensive secretarial services ensure that your company maintains the highest standards of corporate governance 
                and regulatory compliance, allowing you to focus on your core business operations.
              </p>
            </motion.div>
        ...
        >
          <h2 className="text-2xl font-bold text-sage-100 mb-6">Why Choose Adwait Artha LLP for Corporate Services?</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-sage-300 text-sm leading-relaxed">
                Our team of qualified company secretaries and legal experts ensures accurate and timely compliance 
                with all corporate law requirements.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-sage-100 mb-3">Comprehensive Coverage</h3>
              <p className="text-sage-300 text-sm leading-relaxed">
                From basic compliance to complex corporate governance matters, we provide end-to-end support 
                for all your corporate law needs.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-sage-100 mb-3">Technology Integration</h3>
              <p className="text-sage-300 text-sm leading-relaxed">
                Modern e-voting and virtual meeting solutions ensure efficient and secure corporate governance 
            ...
            <div>
              ...
              <p className="text-sage-300 text-sm leading-relaxed">
                Successfully managed corporate compliance for numerous companies across various sectors 
