      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-20">
        ...
        >
          ...
          <p className="text-xl text-sage-300 max-w-4xl mx-auto">
            Expert representation before NCLT, ROC, Regional Directors office, and other statutory
            forums. Our unique ability to perform within given time frames ensures successful
            outcomes for your legal matters.
          </p>
        </motion.div>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            >
              ...
              <p className="text-sage-300 leading-relaxed mb-6">
                To get the approval from various statutory forums like ROC, Regional Directors
                office, Office of Official Liquidator and appearance before the National Company Law
                Tribunal requires appearances, presentation and liasion with such department which
                the firm possess unique ability to perform at their best within the given time
                frame.
              </p>
              <p className="text-sage-300 leading-relaxed">
                Our team of legal experts specializes in representing clients before various
                regulatory bodies and tribunals, ensuring your interests are protected and matters
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => {
                    window.location.href = `/?service=${encodeURIComponent("Regulatory Compliance")}#contact`;
                  }}
        ...
        >
          <h2 className="text-2xl font-bold text-sage-100 mb-6">
            Why Choose Adwait Artha LLP for Tribunal Representation?
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-sage-300 text-sm leading-relaxed">
                Our team has extensive experience in representing clients before various tribunals
                and regulatory bodies, with deep understanding of procedural requirements.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sage-300 text-sm leading-relaxed">
                Successfully represented numerous clients before various tribunals with high success
                rates and satisfied clients across different sectors.
              </p>
            </div>
          </div>
        </motion.div>
