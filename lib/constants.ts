...
const contactAddress = '518, Anand Mangal - III, Opp. Core House, Rajnagar Club Lane, Ambawadi, Ahmedabad - 380006';
...
export { companyEmails, contactEmail, contactPhone, contactAddress, contactBusinessHours, openPositions, benefits, contactInfo, services };